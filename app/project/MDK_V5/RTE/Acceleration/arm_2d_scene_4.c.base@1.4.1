...
static void __after_scene4_switching(arm_2d_scene_t *ptScene)
{
    user_scene_4_t *ptThis = (user_scene_4_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
                                        ...
                                        user_scene_4_t *ptThis)
{
    ...
    *ptThis = (user_scene_4_t){
        .use_as__arm_2d_scene_t = {
            ...
            .fnAfterSwitch  = &__after_scene4_switching,

            /* if you want to use predefined dirty region list, please uncomment the following code */
            //.ptDirtyRegion  = (arm_2d_region_list_item_t *)s_tDirtyRegions,
            
            //.fnOnBGStart    = &__on_scene4_background_start,         /* deprecated */
            //.fnOnBGComplete = &__on_scene4_background_complete,      /* deprecated */
