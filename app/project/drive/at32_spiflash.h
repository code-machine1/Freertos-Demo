...
#define SPI_PERIPH_CLK					CRM_SPI4_PERIPH_CLOCK


#define SPI_CS_PIN						GPIO_PINS_6
#define SPI_CS_GPIO_GROUP				GPIOB
#define SPI_CS_GPIO_GROUP_CLK			CRM_GPIOA_PERIPH_CLOCK

#define SPI_CLK_PIN						GPIO_PINS_7	
#define SPI_CLK_GPIO_GROUP				GPIOB
#define SPI_CLK_GPIO_GROUP_CLK			CRM_GPIOA_PERIPH_CLOCK

#define SPI_MISO_PIN					GPIO_PINS_8
#define SPI_MISO_GPIO_GROUP				GPIOB
#define SPI_MISO_GPIO_GROUP_CLK			CRM_GPIOA_PERIPH_CLOCK

#define SPI_MOSI_PIN					GPIO_PINS_9
#define SPI_MOSI_GPIO_GROUP				GPIOB
